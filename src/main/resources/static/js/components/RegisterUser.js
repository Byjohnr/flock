            ...
            return(
                <div>
                    ...
                    <div className="form-horizontal">
                        ...
                        <div className="form-group">
                            <div>
                                <label className="col-sm-2 control-label" htmlFor="password_verify">Re-enter Password</label>
                            </div>
                            <div className="col-sm-8">
                                <input id="password_verify" className="form-control" type="password" ref="password_verify"/>
                            </div>
                        </div>
                        <input className="btn btn-primary" type="button" onClick={this.handleCreation} value="Create Account" />
                    </div>
                </div>
            )
        } else {
